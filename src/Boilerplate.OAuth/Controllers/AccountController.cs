...
using Boilerplate.OAuth.Extensions;
using Boilerplate.OAuth.Models;
using Boilerplate.OAuth.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    return RedirectToAction(nameof(LoginWithTwoFactor), new { returnUrl, model.RememberMe });
                }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> LoginWithTwoFactor(LoginWith2faViewModel model, bool rememberMe, string returnUrl = null)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
